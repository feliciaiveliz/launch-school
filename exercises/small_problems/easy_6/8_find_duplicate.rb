...
- if value occurs more than once, return it
algorithm: 
- define find_dup(array)
- iterate over method and return num if array.count(num) is greater than 1
- end method
=end

def find_dup(array)
  array.each { |n| return n if array.count(n) > 1 }
end
