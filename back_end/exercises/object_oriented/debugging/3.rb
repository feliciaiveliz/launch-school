...
# Line 42 is not comparing the values of each object, it's actually comparing the objects themselves.
# We need to compare the value of the two locations, latitude and longitude.
