...
# Change private to protected so that other methods of the class can access the serial number.
# protected methods allow us to invoke them with an explicit caller, 'other.serial_number'